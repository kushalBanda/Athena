...
> [!NOTE]
> A `curl | bash` installer and Homebrew tap are planned but not published yet — npm is the only distribution channel today. See [`docs/notes/publish.md`](docs/notes/publish.md).
