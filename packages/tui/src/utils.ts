...
function graphemeWidth(segment: string): number {
  ...
  // Regional indicators render full-width in most terminals; 2 avoids auto-wrap drift.
  ...
  // Intl.Segmenter can group several terminal-spacing code points into one grapheme;
  // count the trailing ones terminals still allocate cells for.
