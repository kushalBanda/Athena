...
} as const satisfies KeybindingDefinitions & Record<Keybinding, KeybindingDefinition>;
...
export class KeybindingsManager {
  ...
  getDefinition(keybinding: Keybinding): KeybindingDefinition {
    // `keybinding` is always a registered id; noUncheckedIndexedAccess can't see that.
