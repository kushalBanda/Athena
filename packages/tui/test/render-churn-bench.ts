 ...
 * frames on a layout mirroring athena's fullscreen interactive mode:
...
async function main(): Promise<void> {
	...
	const tui = new TuiAltScreen(terminal, false, "/tmp/athena-tui-bench");
	...
	const footer = new Text("\x1b[2m~/workspaces/athena  main  100k tokens\x1b[22m", 1, 0);
