...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@athena\/telemetry$/, replacement: telemetryIndex },
			{ find: /^@athena\/agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@athena\/agent-core\/node$/, replacement: agentNode },
			{ find: /^@athena\/agent-core$/, replacement: agentIndex },
			{ find: /^@athena\/ai$/, replacement: aiIndex },
		],
	},
});
