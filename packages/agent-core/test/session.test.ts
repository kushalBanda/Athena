...
import type { Tool, ToolContext, ToolResult } from "@athena/tools";
...
function toolResultMsg(toolCallId: string, content: string): AgentMessage {
  return {
    id: "tr1",
    role: "tool_result",
...
function compactionMsg(summary: string): AgentMessage {
  return {
    id: "cs1",
