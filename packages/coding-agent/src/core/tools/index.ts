...
export type ToolName = "read" | "bash" | "edit" | "write" | "grep" | "find" | "ls" | "websearch";
...
/** The runtime's default active tool selection when no explicit list is configured. */
export const DEFAULT_ACTIVE_TOOL_NAMES: ToolName[] = ["read", "bash", "edit", "write", "websearch"];
