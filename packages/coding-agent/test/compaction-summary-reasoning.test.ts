...
import type { AssistantMessage, Model } from "@kushalbanda/ai";
...
vi.mock("@kushalbanda/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@kushalbanda/ai/compat")>();
	return {
		...actual,
