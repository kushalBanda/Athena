...
import { fauxAssistantMessage, registerFauxProvider, streamSimple } from "@kushalbanda/ai/compat";
...
describe("missing configured theme export", () => {
	...
	it("exports with the active fallback theme when the configured theme is missing", async () => {
		const tempDir = mkdtempSync(join(tmpdir(), "athena-5596-"));
