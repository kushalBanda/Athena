...
const originalOffline = process.env.ATHENA_OFFLINE;
...
afterEach(() => {
	if (originalOffline === undefined) delete process.env.ATHENA_OFFLINE;
	else process.env.ATHENA_OFFLINE = originalOffline;
});
