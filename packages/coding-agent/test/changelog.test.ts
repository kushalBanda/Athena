...
describe("normalizeChangelogLinks", () => {
	test("rewrites package-relative changelog links to tag-pinned GitHub source links", () => {
		...
		expect(normalizeChangelogLinks(markdown, entry)).toBe(
			[
				"[Project Trust](https://github.com/kushalBanda/Athena/blob/v0.79.0/packages/coding-agent/README.md#project-trust)",
				"[Extensions](https://github.com/kushalBanda/Athena/blob/v0.79.0/packages/coding-agent/docs/extensions.md#project_trust)",
				"[Examples](https://github.com/kushalBanda/Athena/tree/v0.79.0/packages/coding-agent/examples/extensions/)",
				"[Root README](https://github.com/kushalBanda/Athena/blob/v0.79.0/README.md#supply-chain-hardening)",
			].join("\n"),
		);
	});
