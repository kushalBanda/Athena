...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@kushalbanda/tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			...
			{
				path: "/tmp/project/.athena/npm/node_modules/athena-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.athena/npm/node_modules/athena-markdown-preview/extensions/index.ts",
					{
						source: "npm:athena-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.athena/npm/node_modules/athena-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.athena/npm/node_modules/@scope/athena-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.athena/npm/node_modules/@scope/athena-scoped/extensions/index.ts",
					{
						source: "npm:@scope/athena-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.athena/npm/node_modules/@scope/athena-scoped",
					},
				),
			},
			{
...
"[Extensions]
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "athena-mono");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
	...
	test("shows full context paths when expanded", () => {
		...
		expect(output).toContain("~/Development/athena-mono/AGENTS.md");
