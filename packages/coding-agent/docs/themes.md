...
```json
{
  "$schema": "https://raw.githubusercontent.com/kushalBanda/Athena/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
