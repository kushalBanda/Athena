...
**Source:** [`@kushalbanda/tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@kushalbanda/tui";
...
```typescript
import { Container, type Focusable, Input } from "@kushalbanda/tui";
...
Import from `@kushalbanda/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@kushalbanda/tui";
```
...
```typescript
import { matchesKey, Key } from "@kushalbanda/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@kushalbanda/tui";
...
```typescript
import { getMarkdownTheme } from "@kushalbanda/athena";
import { Markdown } from "@kushalbanda/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@kushalbanda/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@kushalbanda/athena";
import { DynamicBorder } from "@kushalbanda/athena";
import { Container, type SelectItem, SelectList, Text } from "@kushalbanda/tui";
...
For toggling multiple settings. Use `SettingsList` from `@kushalbanda/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@kushalbanda/athena";
import { Container, type SettingItem, SettingsList, Text } from "@kushalbanda/tui";
...
import { matchesKey, truncateToWidth } from "@kushalbanda/tui";
