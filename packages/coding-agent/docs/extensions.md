...
| Package | Purpose |
|---------|---------|
| `@kushalbanda/athena` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@kushalbanda/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@kushalbanda/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@kushalbanda/athena";
...
```typescript
import { isBashToolResult } from "@kushalbanda/athena";
...
```typescript
import { createLocalBashOperations } from "@kushalbanda/athena";
...
```typescript
import { SessionManager } from "@kushalbanda/athena";
...
athena.sendUserMessage("/review src/index.ts", { expandPromptTemplates: true });
```
...
```typescript
import type { AutocompleteItem } from "@kushalbanda/tui";
...
Extensions that need native provider auth, filtering, refresh, or stream behavior can register a complete `Provider` from `@kushalbanda/ai`. The provider becomes the composition base and `models.json` overrides still apply above it.

```typescript
import { createProvider, openAICompletionsApi } from "@kushalbanda/ai";
...
```typescript
import { withFileMutationQueue } from "@kushalbanda/athena";
...
**Important:** Use `StringEnum` from `@kushalbanda/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@kushalbanda/athena";
...
```typescript
import { createBashTool } from "@kushalbanda/athena";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/kushalBanda/Athena/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@kushalbanda/athena";
...
```typescript
import { Text, Component } from "@kushalbanda/tui";
...
import { matchesKey } from "@kushalbanda/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@kushalbanda/athena";
