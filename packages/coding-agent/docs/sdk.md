...
```bash
npm install @kushalbanda/athena
```
...
The `Agent` class (from `@kushalbanda/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@kushalbanda/athena";
...
```typescript
import { InMemoryCredentialStore } from "@kushalbanda/ai";
import { createAgentSession, ModelRuntime } from "@kushalbanda/athena";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@kushalbanda/athena";
...
import { createAgentSession, defineTool } from "@kushalbanda/athena";
...
```typescript
import type { InlineExtension } from "@kushalbanda/athena";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@kushalbanda/athena";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@kushalbanda/athena";
