...
| `send-user-message.ts` | Demonstrates `athena.sendUserMessage()` for sending user messages from extensions |
...
| `event-bus.ts` | Inter-extension communication via `athena.events` |
